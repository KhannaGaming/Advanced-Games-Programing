...
void RenderFrame(void)
{
	...
	world = XMMatrixRotationX(XMConvertToRadians(xDegrees));
	world *= XMMatrixRotationY(XMConvertToRadians(yDegrees));
	world *= XMMatrixRotationZ(XMConvertToRadians(zDegrees));
